 ...
 * 	       wp eval-file wp-content/plugins/notification-signature/bin/dump-hooks.php
 *
 * @package notification/signature
 */

$runtime    = NotificationSignature::runtime();
...
$objects = [];
foreach ( NotificationSignature::components() as $component_name => $instance ) {
